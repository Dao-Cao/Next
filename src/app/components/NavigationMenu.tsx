...
const NavigationMenu: FC<NavigationMenuProps> = ({}) => {
  ...
  const Menus = [
    ...
    { title: "実技学科インポート", spacing: true, icon: <AiOutlineMail /> },
    { title: "ユーザー管理", icon: <AiOutlineUser /> },
    { title: "ランキング表", icon: <AiOutlineBarChart /> },
    { title: "ログアウト", spacing: true, icon: <AiOutlineLogout /> },
  ];
  return (
    <>
      {/* <div className="flex"> */}
      ...
      >
        ...
        <div className="inline-flex">
          ...
          />
          <h1
            className={` origin-left text-2xl duration-300 ${
              !open && "hidden"
            }`}
          >
            <img
              className="mx-auto h-10 w-40"
              src="/images/custom-logo-login.svg"
              alt="Your Company"
            />
          </h1>
        </div>
